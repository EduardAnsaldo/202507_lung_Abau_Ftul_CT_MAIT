...
```{r}
da_results_Abau_vs_Ftula_old <- da_results_Abau_vs_Ftula
head(da_results_Abau_vs_Ftula)
trajectory_milo <- logNormCounts(trajectory_milo)
da_results_Abau_vs_Ftula$NhoodGroup <- as.numeric(da_results_Abau_vs_Ftula$SpatialFDR < 0.1 & da_results_Abau_vs_Ftula$logFC < 0)
da_results_Abau_vs_Ftula <- findNhoodMarkers(trajectory_milo, da_results_Abau_vs_Ftula, aggregate.samples = T, sample_col = 'Samples')
da_results_Abau_vs_Ftula |> head()
# str(trajectory_milo, max.level = 1)
# str(seurat_sce, max.level = 1)
# rowData(seurat_sce) |> rownames()
# rowData(trajectory_milo) |> rownames()
```
