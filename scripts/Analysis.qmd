...
results_tables <-run_cnmf_results(
    ...
    object_annotations = '',
    top_n = 30,                # top genes per program to extract
...
seurat <- 
    (seurat, resolution = resolutions, verbose = F, algorithm = 4, random.seed = 3514L)
...
![](/results/cNMF/cNMF_run_Abau_only/cNMF_run_Abau_only.k_selection.png)
...
plot1 <- top_genes_per_cluster(seurat, n_genes_to_plot=7, object_annotations, tables_path = tables_path, figures_path = figures_path, results_path = results_path, run_pathway_enrichment = T) 
```
